...
insert into COURSE(ID, NAME, LAST_UPDATE, CREATION_DATE) VALUES(5, 'Spring React Full Stack', SYSDATE(), SYSDATE());
insert into COURSE(ID, NAME, LAST_UPDATE, CREATION_DATE) VALUES(6, 'Spring Rest Api', SYSDATE(), SYSDATE());
insert into COURSE(ID, NAME, LAST_UPDATE, CREATION_DATE) VALUES(7, 'Spring Masterclass', SYSDATE(), SYSDATE());
...
insert into Review(ID, DESCRIPTION, RATING, COURSE_ID, STUDENT_ID) VALUES(2, 'Interesting', '4,5', 3, 3);
